<footer class="site-footer">
  <div class="container">
    <div class="row">
      <div class="col-md-4">
        <aside class="widget widget_text"><h3 class="widget-title"><span>Nosotros</span></h3>
          <div class="textwidget">
            <p>
              <img alt="Asaliah Logo" src="images/logos/logo.png">
              <br>
              © Asaliah - Perfiles, Chapas, Corralón de Materiales - Venta por Mayor y Menor.
            </p>
          </div>
        </aside>
      ...
      <div class="col-sm-6 col-md-4">
        <aside class="widget widget_text">
          <h3 class="widget-title"><span>INFO útil</span></h3>
          <div class="textwidget">
            <div class="office">
              <p><i class="fa fa-map-marker"></i> Firpo 241, La Unión - Ezeiza
              </p>
              <p><i class="fa fa-phone"></i> +54 11 4034 6551 </p>
              <p><i class="fa fa-envelope"></i> asaliahmarita@gmail.com </p>
