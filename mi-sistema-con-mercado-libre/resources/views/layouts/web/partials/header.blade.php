<div class="row">
    <div class="col-xs-10 col-lg-2 site-branding">
        <a href="#" rel="home">
            <img src="images/logos/logo.png" alt="Transport – Transport, Logistic &amp; Warehouse WP">
        </a>
    </div>
        ...
        <div class="site-info">
            ...
            <div class="row">
                ...
                <div class="top-menu">
                    ...
                    <li class="menu-item">
                        <a href="#">Asaliah - Perfiles, Chapas, Corralón de Materiales - Venta por Mayor y Menor.</a>
                        <!-- <ul class="sub-menu">
            ...
            <div class="row">
                ...
                <div class="contact-detail">
                    ...
                    <div class="col-md-4 col-xl-3 col-xl-offset-1">
                        ...
                        <h3>+54 11 4034 6551</h3>
                        <span>asaliahmarita@gmail.com</span>
                    </div>
                    <div class="col-md-4">
                        <i class="fa fa-home"></i>
                        <h3>Firpo 241, La Unión</h3>
                        <span>Ezeiza</span>
                    </div>
                    <div class="col-md-4">
                        <i class="fa fa-clock-o"></i>
                        <h3> Lunes a Viernes de 08:00 a 16:00 Hs. Sábados de 08:00 a 13:00 Hs.</h3>
                ...
                <div class="col-lg-1 hidden-xs hidden-sm hidden-md search-box">
                    <a href="/login"><i class="fa fa-share"></i><span style="padding-left: 0rem;">Login</span></a>
                </div> 
